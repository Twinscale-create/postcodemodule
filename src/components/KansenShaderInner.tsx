...
// Kansen tab — rood/donkerrood waterplane, uSpeed=0.1 (rustig)
const URL =
  'animate=on&brightness=1&cAzimuthAngle=180&cDistance=2.8&cPolarAngle=80' +
  '&cameraZoom=9.1&color1=%23800000&color2=%23ca0300&color3=%23212121' +
...
export default function KansenShaderInner() {
  return (
